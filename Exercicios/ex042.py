...
if r1 >= r2 and r1 >= r3:
    if r2 + r3 > r1:
        ...
        if r1 == r2 and r1 == r3:
            print('\nÉ um triângulo \033[1;35mequilátero\033[m.')
        elif r1 == r2 and r1 != r3 or r2 == r3 and r2 != r1 or r3 == r1 and r3 != r2:
            print('\nÉ um triângulo \033[1;35misósceles\033[m.')
        elif r1 != r2 and r1 != r3 and r2 != r3:
            print('\nÉ um triângulo \033[1;35mescaleno\033[m.')
    else:
...
if r2 > r1 and r2 >= r3:
    if r1 + r3 > r2:
        print('\033[1;32mDá para fazer um triângulo!\033[m')
        if r1 == r2 and r1 != r3 or r2 == r3 and r2 != r1 or r3 == r1 and r3 != r2:
            print('\nÉ um triângulo \033[1;35misósceles\033[m.')
        elif r1 != r2 and r1 != r3 and r2 != r3:
            print('\nÉ um triângulo \033[1;35mescaleno\033[m.')
    else:
